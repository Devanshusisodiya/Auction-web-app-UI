...
class StaticListings extends StatefulWidget {
  @override
  _StaticListingsState createState() => _StaticListingsState();
}

class _StaticListingsState extends State<StaticListings> {
  bool loggedIn = true;
